...
ansible-playbook -i inventory.ini openshift-ansible/playbooks/prerequisites.yml --connection=local
ansible-playbook -i inventory.ini openshift-ansible/playbooks/deploy_cluster.yml --connection=local
